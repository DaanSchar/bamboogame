...
import com.maastricht.university.logic.ai.reinforcement.environment.Environment;
...
public class Train {
    ...
    public static void train() {
        ...
        String randomNetworkName = "src/main/resources/networks/network-" + System.currentTimeMillis() + "AB.zip";
