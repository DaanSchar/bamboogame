...
//                new RandomAgent(new GameState(4, 2), 2)
                new AlphaBetaAgent(new GameState(4, 2), 2, 2, new ReinforceEval("src/main/resources/networks/network-hybrid-1641504372936.zip"))
        );
    }
}
