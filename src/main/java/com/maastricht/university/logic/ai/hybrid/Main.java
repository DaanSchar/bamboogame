...
//        evaluate();
    ...
    static void evaluate() {
        String networkName = "src/main/resources/networks/evaluationNetwork/semiAB/network-hybrid-score-semiAB-0.01-99.zip";
        Evaluation.evaluateNetwork(
//                new AlphaBetaAgent(new GameState(4, 2), 1, 2, new Evaluation1()),
                new RandomAgent(new GameState(4, 2), 1),
                new AlphaBetaAgent(new GameState(4, 2), 2, 2, new ReinforceEval(networkName))
        );
    }
}
